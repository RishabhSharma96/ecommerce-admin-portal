        ...
        <div>
            <div className="md:w-[17rem] w-12 h-screen text-white flex flex-col pl-8 gap-4 pt-4 text-l font-poppins">
                <Link className="flex mt-3 font-bold gap-3 text-2xl" href="/">
                    <svg className="h-[30px] text-pink-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0012 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75z" />
                    </svg>
                    <span className="hidden md:flex">ShopIt Admin</span>
                </Link>
                ...
                <Link className={pathname === "/products" || pathname.includes("/products") ? activeLink : inactiveLink} href="/products">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <Link className={pathname === "/customers" ? activeLink : inactiveLink} href="/customers">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <Link className={pathname === "/utilities" ? activeLink : inactiveLink} href="/utilities">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-6 h-6">
