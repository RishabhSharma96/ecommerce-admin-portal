                ...
                <div className="w-screen h-screen bg-blue-900 flex">
                    ...
                    <div className="bg-white flex flex-col flex-grow ml-[-10px] m-2 rounded-xl p-5 gap-4 items-center overflow-hidden overflow-y-scroll">
                        ...
                        <div className='flex flex-col justify-center items-center gap-3'>
                            ...
                            <select value={productCategory} className='h-10 w-[250px] md:w-[400px] border border-gray-500 rounded-xl p-2 pl-4 focus:outline-blue-500 appearance-none' onChange={(e) => setProductCategory(e.target.value)}>
