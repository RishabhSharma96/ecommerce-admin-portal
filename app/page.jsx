        ...
        return (
            <div >
                <div className="w-screen h-screen bg-blue-900 flex">
                    ...
                    <div className="bg-white flex-grow ml-[-10px] m-2 rounded-xl overflow-hidden overflow-y-scroll">
                        ...
                        {products && categories && orders.length > 0 && admins && customers && items && price && (
                            <div className="bg-white flex flex-col flex-grow ml-[-10px]rounded-xl p-5 gap-5 items-center ">
                                ...
                                <div className="flex gap-5 flex-wrap justify-center items-center">
                                    <div className="flex w-[15rem] h-[10rem] p-2 rounded-xl text-white  bg-gradient-to-r from-indigo-500 to-indigo-200 gap-5 justify-center items-center">
                                    ...
                                    <div className="flex w-[15rem] h-[10rem] p-2 rounded-xl text-white  bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 gap-5 justify-center items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
